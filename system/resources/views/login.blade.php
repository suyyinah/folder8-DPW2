...
<body class="img js-fullheight" style="background-image: url(public/login/images/pasta.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">FOODBLOGGER.ID</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<h3 class="mb-4 text-center">DO YOU HAVE ACCOUNT?</h3>
						...
						<form action="{{ url('login')}}" class="signin-form" method="post">
							...
							<div class="form-group">
								<input id="password-field" type="password" class="form-control" placeholder="Masukan Password" name='password' required>
						...
						<div class="social d-flex text-center">
							...
							<a href="#" class="px-2 py-2 ml-md-1 rounded"><span class="ion-logo-Instagram mr-2"></span> Instagram</a>
						</div>
					</div>
				</div>
			</div>
